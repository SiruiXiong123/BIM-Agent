...
- [t6-streamlit-mvp](pages/t6-streamlit-mvp.md) — category: decision | tags: [t6, streamlit, web, mvp] | - T6 初版只采用 Streamlit，不同时引入 FastAPI；业务边界保持为 `src/review/models.py` 数据契约、`src/review/service.py` 编排 T1–T5、`app/main.py` 页面交互。
